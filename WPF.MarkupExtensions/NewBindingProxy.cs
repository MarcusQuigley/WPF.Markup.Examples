...
{
    class NewBindingProxy : Freezable
    {
        protected override Freezable CreateInstanceCore()
        {
            return new NewBindingProxy();
        }
        ...
        public static readonly DependencyProperty DataProperty =
            DependencyProperty.RegisterAttached("Data", typeof(object), typeof(NewBindingProxy), new PropertyMetadata(null));
